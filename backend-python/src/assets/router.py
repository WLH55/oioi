...
from src.schemas import ApiResponse, ListResponse
from .schemas import (
    AssetCreate,
    AssetUpdate,
    AssetResponse,
...
async def list_assets(
    ...
    drama_id: Optional[int] = Query(None, description="剧目 ID 过滤"),
    episode_id: Optional[int] = Query(None, description="集数 ID 过滤"),
